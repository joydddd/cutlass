...
class CnCOverrideContext:
    ...
    def __enter__(self):
        ...
        # NOTE: Function overrides are handled by wrapper-style dispatch
        # in ``register_func_override`` and do not require attribute
        # swapping here.
...
__all__ = ["register_cls_extension", "register_func_override", "CnCOverrideContext"]
